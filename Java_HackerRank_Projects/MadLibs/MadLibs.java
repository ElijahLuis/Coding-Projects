...
public class MadLibs {
    ...
    public void setRandomNums(){
        int num = Math.abs(rand.nextInt()) % 100; // grabs remainder
        int index = 0;
        int[] numberHolder = new int[3]; // three row array, start at 0
        while (index < numberHolder.length) {
            numberHolder[index] = num + index;
            index++;
        }
        randomNums = "not " + numberHolder[0] + ", not "
                + numberHolder[1] + ", but " + numberHolder[2];
    }
    ...
    public void enterAdjective1() {
        System.out.println("Give me a fuckin' adjective!");
        setAdjective1(scanner.nextLine());
    }
    
    public void enterAdjective2() {
        System.out.println("Yeah bitch! Another adjective!");
        setAdjective2(scanner.nextLine());
    }
    
    public void enterAdverb() {
        System.out.println("I REALLY need an adverb now, daddy.");
        setAdverb(scanner.nextLine());
    }
    
    public void putTogetherTheStory() {
        String story;
        int num = Math.abs(rand.nextInt()) % 2; // grabs remainder
        if (num == 0) {
        story = "Jesse and her best friend " + getName() +
            ...
            story = "Amanda and her frenemy " + getName() + " went to the zoo last summer. " +
                    ...
                    + "they decided to climb " + getAdverb() + " into the " + getNoun3() + 
                    " to get a closer look. " + "The zoo was " + getAdjective1() + " at night, but they didn't care..." +
